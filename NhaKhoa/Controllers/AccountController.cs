...
namespace NhaKhoa.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var user = await FindUserByEmailOrUserNameAsync(model.EmailOrUserName);
        ...
        private async Task<ApplicationUser> FindUserByEmailOrUserNameAsync(string emailOrUserName)
        {
            ...
            // Thử tìm kiếm người dùng bằng email
            user = await UserManager.FindByEmailAsync(emailOrUserName);

            if (user == null)
            {
                // Nếu không tìm thấy bằng email, thử tìm kiếm bằng tên người dùng
