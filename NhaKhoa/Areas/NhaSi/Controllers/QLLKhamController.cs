    ...
    public class QLLKhamController : Controller
    {
        ...
        public ActionResult Index(string searchString, string filterDate)
        {
            ...
            if (DateTime.TryParse(filterDate, out var selectedDate))
            {
                ...
                IQueryable<PhieuDatLich> phieuDatLiches = db.PhieuDatLich
        ...
        public ActionResult ViewAllBooking(string searchString, string filterDate)
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
            {
                phieuDatLiches = phieuDatLiches
                    .Where(p => p.AspNetUsers.Email.Contains(searchString) || p.AspNetUsers.FullName.Contains(searchString));
            }
        ...
        public ActionResult LapDonThuoc(int? id_phieudat)
        {
            ...
            PhieuDatLich phieuDatLich = db.PhieuDatLich.Find(id_phieudat);
            ...
            List<ThuocCheckBox> thuocs = db.Thuoc
        ...
        public ActionResult LapDonThuoc(LapDonThuocViewModel viewModel)
        {
            ...
            try
            {
                ...
                viewModel.DonThuoc.PhieuDatLich = db.PhieuDatLich.Find(viewModel.DonThuoc.Id_phieudat);

                // Save the prescription to the database
                db.DonThuoc.Add(viewModel.DonThuoc);
                ...
                {
                    var giaThuoc = db.Thuoc.Find(thuoc.Id_thuoc)?.Gia ?? 0;
                    ...
                    viewModel.DonThuoc.ChiTietThuoc.Add(chiTietThuoc);
                    ...
                    var thuocToUpdate = db.Thuoc.Find(thuoc.Id_thuoc);
